...
class AdminUnicatController extends Controller
{
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function propertiesGroupCreateAction(Request $request, $configuration)
    {
        $urm = $this->get('unicat')->getConfigurationManager($configuration);
        ...
        return $this->render('UnicatModule:Admin:properties_group_create.html.twig', [
            'form'       => $form->createView(),
            'configuration' => $urm->getConfiguration(), // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
     ...
     * @return \Symfony\Component\HttpFoundation\RedirectResponse|\Symfony\Component\HttpFoundation\Response
     */
    public function propertiesAction(Request $request, $configuration, $group_id)
    {
        ...
        return $this->render('UnicatModule:Admin:properties.html.twig', [
            'form'       => $form->createView(),
     ...
     * @return \Symfony\Component\HttpFoundation\Response
     */
    public function propertyAction(Request $request, $configuration, $group_id, $id)
    {
        $unicat = $this->get('unicat');
        $configuration = $unicat->getConfiguration($configuration);
        ...
        return $this->render('UnicatModule:Admin:property.html.twig', [
            'form'       => $form->createView(),
            'configuration' => $configuration, // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
