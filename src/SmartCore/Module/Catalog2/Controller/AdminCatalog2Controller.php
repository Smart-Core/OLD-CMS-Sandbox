...
class AdminCatalog2Controller extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        return $this->render('Catalog2Module:Admin:index.html.twig', [
            'repositories' => $em->getRepository('Unicat2Bundle:UnicatRepository')->findAll(),
        ]);
    }
    ...
    public function categoryEditAction(Request $request, $structure_id, $id, $repository)
    {
        ...
        return $this->render('Catalog2Module:Admin:category_edit.html.twig', [
            'category'   => $category,
...
//        $form = $unicat->getCategoryCreateForm($structure, [], $parent_category);
        ...
        return $this->render('Catalog2Module:Admin:structure.html.twig', [
            'form'       => $form->createView(),
            'repository' => $structure->getRepository(), // @todo убрать, это пока для наследуемого шаблона.
            'structure'  => $structure,
        ]);
    ...
    public function structureCreateAction(Request $request, $repository)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->get('cancel')->isClicked()) {
                return $this->redirect($this->generateUrl('smart_module.catalog2_repository_admin', ['repository' => $repository]));
            }
        ...
        return $this->render('Catalog2Module:Admin:structure_create.html.twig', [
            'form'       => $form->createView(),
    ...
    public function structureEditAction(Request $request, $id, $repository)
    {
        ...
        return $this->render('Catalog2Module:Admin:structure_edit.html.twig', [
            'form'       => $form->createView(),
            'repository' => $urm->getRepository(), // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
    ...
    public function propertiesGroupCreateAction(Request $request, $repository)
    {
        ...
        return $this->render('Catalog2Module:Admin:properties_group_create.html.twig', [
            'form'       => $form->createView(),
            'repository' => $urm->getRepository(), // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
    ...
    public function propertiesAction(Request $request, $repository, $group_id)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('smart_module.catalog2_properties_admin', ['repository' => $repository->getName(), 'group_id' => $group_id]));
            }
        }

        return $this->render('Catalog2Module:Admin:properties.html.twig', [
            'form'       => $form->createView(),
    ...
    public function propertyAction(Request $request, $repository, $group_id, $id)
    {
        ...
        return $this->render('Catalog2Module:Admin:property.html.twig', [
            'form'       => $form->createView(),
            'repository' => $repository, // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
    ...
    public function itemCreateAction(Request $request, $repository, $default_category_id = null)
    {
        ...
        return $this->render('Catalog2Module:Admin:item_create.html.twig', [
            'form'       => $form->createView(),
            'repository' => $urm->getRepository(), // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
    ...
    public function itemEditAction(Request $request, $repository, $id)
    {
        ...
        return $this->render('Catalog2Module:Admin:item_edit.html.twig', [
            'form'       => $form->createView(),
            'repository' => $urm->getRepository(), // @todo убрать, это пока для наследуемого шаблона.
        ]);
    }
    ...
    protected function redirectToRepositoryAdmin(UnicatRepository $repository)
    {
        ...
        $url = $request->query->has('redirect_to')
            ...
            : $this->generateUrl('smart_module.catalog2_repository_admin', ['repository' => $repository->getName()]);
    ...
    protected function redirectToStructureAdmin(UnicatRepository $repository, $structure_id)
    {
        ...
        $url = $request->query->has('redirect_to')
            ? $request->query->get('redirect_to')
            : $this->generateUrl('smart_module.catalog2_structure_admin', ['id' => $structure_id, 'repository' => $repository->getName()]);
