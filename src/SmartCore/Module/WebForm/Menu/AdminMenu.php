...
class AdminMenu extends ContainerAware
{
    ...
    public function manage(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('New messages', ['route' => 'web_form.admin_new_messages',  'routeParameters' => ['name' => $webForm->getName() ]]);
        $menu->addChild('In progress',  ['route' => 'web_form.admin_in_progress',   'routeParameters' => ['name' => $webForm->getName() ]]);
